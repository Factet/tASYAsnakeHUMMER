...
//    virtual void SetOrigin(const Point &pos) = 0;
    ...
    virtual void DisplayImage(const IMAGEINFO ii, const Point &position, double scaleX, double scaleY) = 0;
};
...
public:
    ...
    virtual void DisplayImage(const IMAGEINFO imageptr, const Point &position, double scaleX, double scaleY);
